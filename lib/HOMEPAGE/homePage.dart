                              ...
                              return ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    String userId = snapshot
                                        .data.documents[index]['userid'];
                                    String cityid = snapshot
                                        .data.documents[index]['cityid'];

                                    var usersMap =
                                        snapshot2.data.documents.asMap();
                                    var CitiesMap =
                                        snapshot3.data.documents.asMap();
                                    var ExperienceMap =
                                    ...
                                    usersMap.forEach((len, snap) {
                                      ...
                                      if (snap.documentID == userId) {
                                        ...
                                        hometown =
                                            snap.data["hometown"].toString();
                                        timestamp =
                                            snap.data["timestamp"].toString();
                                      }
                                    });
                                                                    ...
                                                                    Container(
                                                                      child:
                                                                        ...
                                                                        children: <
                                                                          ...
                                                                          Text(
                                                                              firstName,
                                                                              style: TextStyle(color: Colors.teal, fontSize: 22, fontFamily: 'Bitter', fontWeight: FontWeight.w600)),
                                                                          Text(
                                                                              " "),
                                                                          Text(
                                                                              lastName,
