...
import 'package:traveliano/adminScreens/restuarant/addImage.dart' as restuarantImg;
...
MyApp(City city,Restuarant restuarant){
this._restuarant=restuarant;
this.city=city;
}

  @override
  MyAppState createState() => MyAppState(city,_restuarant);
}
...
class MyAppState extends State<MyApp> {
 ...
 Restuarant _restuarant =new Restuarant();
 City city =new City();
//LatLng latCity=LatLng(this.city.longtude,this.city.longtude);
MyAppState(City city1,Restuarant restuarant){
this._restuarant=restuarant;
this.city=city1;
}
...
//////////////new attribute
 // Completer<GoogleMapController> _controller = Completer();
  ...
  searchandNavigate() {
    Geolocator().placemarkFromAddress(this._restuarant.Name+" Restaurant "+
    this.city.Name).then((result) {
...
//_lastMapPosition=CameraPosition(target: ).target;
 ...
 _markers.add(Marker(
  ...
  setState(() {
      this._restuarant.latitude=result[0].position.latitude;
      this._restuarant.longtude=result[0].position.longitude;
...
//save in City class
this._restuarant.latitude=_lastMapPosition.latitude;

this._restuarant.longtude=_lastMapPosition.longitude;
...
*/
  ...
  Navigator.pushReplacement(
    context,
    MaterialPageRoute(builder: (context) => restuarantImg.UploadImage(this.city,this._restuarant),
  ));
